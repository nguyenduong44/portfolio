...
function GlobalStyle({children}) {
  useEffect(() => {
    ...
    const moveCursor = (e) => {
      ...
      || element?.closest('ol') || element?.closest('Link') || element?.closest('strong') || element?.closest('p') || element?.closest('a') || element?.closest('form') || element?.closest('video') || element?.closest('iframe') || element?.closest('img');
